...
import net.mcreator.elemantalimitation.block.MagicalLiquidStorageBlock;
...
public class MagicalliquidstorageemptyupdatetickProcedure extends ElemantalImitationModElements.ModElement {
	public MagicalliquidstorageemptyupdatetickProcedure(ElemantalImitationModElements instance) {
		super(instance, 36);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure Magicalliquidstorageemptyupdatetick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure Magicalliquidstorageemptyupdatetick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure Magicalliquidstorageemptyupdatetick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure Magicalliquidstorageemptyupdatetick!");
			return;
		}
		...
		ElemantalImitationModVariables.MapVariables.get(world).WaterInStorage = (double) (new Object() {
		...
		if ((((new Object() {
		...
		}.getAmount(new BlockPos((int) x, (int) y, (int) z), (int) (1))) < 16) && (((new Object() {
			...
			}
			{
				...
				BlockState _bs = MagicalLiquidStorageBlock.block.getDefaultState();
